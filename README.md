...
- <img src="guide_img/icons/question.png" width="15" height="15">  **Turtle WoW**: turtle-wow.org - works, but doesn't hook when the animation of jerking isn't complete (the bobber doesn't dive into the water completely, for some reason it sometimes happen on Turtle WoW).
